...
const Dribbble = (props: DribbbleProps) => (
    <DribbbleContainer>
        <DribbbleHolder>
            ...
            <ProgressiveImage
                src={props.card.data.images.hidpi ? props.card.data.images.hidpi : props.card.data.images.normal}
                placeholder={props.card.data.images.teaser} fallbackSeed={props.card._id}/>
        </DribbbleHolder>
    </DribbbleContainer>
);
